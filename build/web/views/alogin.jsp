<%-- 
    Document   : alogin
    Created on : Jul 6, 2022, 8:06:24 AM
    Author     : masad
--%>
	...
	<div class="title">
		<div class="form">
			...
			<form id="login" class="input-form" onsubmit="return validation()" action="LoginCRUD">
				...
				<div id="question">
					<a href="/project2/clogin">Are you User?</a>
				</div>
			</form>
			...
			<form id="register" class="input-form" action="LoginCRUD">
				...
				<input type="email" name="email" class="input-field" placeholder="Email" required>
                                ...
                                <input type="password" name="passcode" class="input-field" placeholder="Admin Code" required>				
